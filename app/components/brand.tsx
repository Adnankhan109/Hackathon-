...
const Brand = () => {
  return (
    <>
      <section>
        <div className="px-4 md:px-5 py-12 text-[#2A254B] mt-8">
          {/* Title */}
          ...
          {/* Features */}
          <div className="flex flex-col md:flex-row gap-8 md:gap-4 lg:gap-8 mt-12 text-base md:text-lg">
            {/* Feature 1 */}
            <div className="flex flex-col   md:w-[25%] p-3  rounded-lg">
