      ...
      <section>
        <div className="px-4 md:px-8 lg:px-12 py-8 md:py-12">
            ...
            {['chair', 'vase', 'silky', 'lamp'].map((item, idx) => (
              <div key={idx} className="w-full">
                <Image
                  ...
                  width={700}
                  alt={item}
                  className="w-full h-auto object-cover transition-all duration-500 ease-in-out hover:scale-105 hover:translate-y-1 hover:border-4 hover:border-[#4E4D93] hover:shadow-lg"
                />
          ...
          <div className="my-10 flex justify-center">
            <button className="bg-[#F9F9F9] py-3 px-6 rounded-[5px] text-[#2A254B] transition-all duration-300 ease-in-out hover:bg-[#2A254B] hover:text-[#F9F9F9] hover:scale-105 hover:shadow-md">
              View collection
            </button>
          </div>
